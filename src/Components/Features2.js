    ...
    <div>
      <div class="container mx-auto px-6 p-6 bg-white dark:bg-gray-800">
        ...
        <div class="flex flex-wrap my-12 dark:text-white">
          <div class="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 ...">
          ...
          <div class="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8 hover:-translate-y-1 hover:scale-110  duration-300 ...">
            <div class="flex items-center mb-6">
              <svg
                width="20"
                height="20"
          ...
          <div class="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8 hover:-translate-y-1 hover:scale-110  duration-300 ...">
            <div class="flex items-center mb-6">
              <svg
                width="20"
                height="20"
          ...
          <div class="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8 hover:-translate-y-1 hover:scale-110  duration-300 ...">
            <div class="flex items-center mb-6">
              <svg
                width="20"
                height="20"
          ...
          <div class="w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8 hover:-translate-y-1 hover:scale-110  duration-300 ...">
            <div class="flex items-center mb-6">
              <svg
                width="20"
                height="20"
